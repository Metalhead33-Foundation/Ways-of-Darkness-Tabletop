...
\item \textbf{The religion's doctrines, core tenets and virtues:} %\item \textbf{The religions's virtues:} These determine what kind of actions are approved by the deity or deities of the religion, thus letting the character gain back favour, in case they previously incurred the wrath of the deitiy or deities. A religion's virtues also directly determine which Schools of Magic are open to Clerical Magic spellcasters following the religion.
    \begin{itemize}
        \item \textbf{Virtues:} These determine what kind of actions are approved by the deity or deities of the religion, thus letting the character gain back favour, in case they previously incurred the wrath of the deitiy or deities. A religion's virtues also directly determine which Schools of Magic are open to Clerical Magic spellcasters following the religion.
        \item \textbf{Doctrines:} Divided into doctrine groups, from which the religion must select one from each category \textit{(except for special doctrines)}. Some are purely cosmetic and for flavour, some actually have genuine effects. There is some overlap with \textbf{Virtues}.
        \item \textbf{Core Tenets:} These are essentially quasi-doctrines that don't fit into any major doctrine group, but are still important and define the religion. Once again, some overlap with \textbf{(Virtues)}.
    \end{itemize}
